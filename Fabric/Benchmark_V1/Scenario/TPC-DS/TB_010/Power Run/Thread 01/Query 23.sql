...
*/
    ...
    /*************************************   TPC-DS Query 23   *************************************/
        ...
        group by substring(i_item_desc,1,30),i_item_sk,d_date /* group by substr(i_item_desc,1,30),i_item_sk,d_date */
          having count(*) >4),
         max_store_sales as
         (select max(csales) tpcds_cmax 
          from (select c_customer_sk,sum(ss_quantity*ss_sales_price) csales
                ...
                where ss_customer_sk = c_customer_sk
                 ...
                 and d_year in (1998,1998+1,1998+2,1998+3) 
        group by c_customer_sk) AS x), /* group by c_customer_sk)), */
         best_ss_customer as
